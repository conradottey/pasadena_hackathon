...
describe "collisions/new" do
  before(:each) do
    assign(:collision, stub_model(Collision,
  ...
  it "renders new collision form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", collisions_path, "post" do
